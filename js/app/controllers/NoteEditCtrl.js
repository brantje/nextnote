	...
	angular.module('NextNotesApp').controller('NoteEditCtrl', [
		...
		function ($scope, $rootScope, NoteService, $routeParams, $location, $timeout,
			...
			$scope.tinymceOptions = {
				...
				toolbar1: 'print fullscreen | undo redo | styleselect fontselect | bold italic strikethrough | forecolor backcolor | alignleft aligncenter alignright alignjustify | bullist numlist table outdent indent | link image bdesk_photo insertdatetime | codesample help | code  ',
				image_advtab: true,
