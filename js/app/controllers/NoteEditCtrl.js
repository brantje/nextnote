	...
	angular.module('NextNotesApp').controller('NoteEditCtrl', [
		...
		function ($scope, $rootScope, NoteService, $routeParams, $location, $timeout,
			...
			$scope.tinymceOptions = {
				...
				toolbar: 'print fullscreen | undo redo | formatselect fontselect fontsizeselect | bold italic strikethrough subscript superscript | emoticons | forecolor backcolor | alignleft aligncenter alignright alignjustify | bullist numlist table outdent indent | link image bdesk_photo insertdatetime toc | codesample help | code',
				image_advtab: true,
