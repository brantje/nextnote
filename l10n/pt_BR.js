OC.L10N.register(
    ...
    "Synchronized groups merge all shared notes, that have the same groupnames in the same group. Standalone groups get separate groups with their owner in the name. If 'UserA' shares a note in 'GroupX' with 'UserB', that also has a group called 'GroupX', 'Synchronized' will show them in the group 'GroupX' and 'Standalone' will show two groups 'GroupX' and 'GroupX (UserA)' for 'UserB'." : "Grupos sincronizados mesclam todas as anotações compartilhadas que possuam os mesmos nomes de grupos no mesmo grupo. Grupos autônomos obtêm grupos separados com seus proprietários no nome. Se 'UsuárioA' compartilha anotações no 'GrupoX' com 'UsuárioB', que também tem um grupo chamado 'GrupoX', 'Sinchronizados' irá exibi-los no grupo 'GrupoX' e 'Autônomo' exibirá dois grupos 'GrupoX' e 'GrupoX (UsuárioA)' para 'UsuárioB'.",
